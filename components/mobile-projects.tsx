      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-4 lg:gap-6 items-start">
          ...
          <div className="flex justify-center">
            <MobileProjectCard isVideo={true} videoSrc="/videos/new-mobile-app-1.mp4" alt="E-commerce mobile app" />
          </div>
          ...
          <div className="flex justify-center">
            <MobileProjectCard isVideo={true} videoSrc="/videos/new-mobile-app-3.mp4" alt="Banking mobile app" />
          </div>
        </div>
        ...
        <div className="md:hidden flex flex-col gap-8">
          ...
          <div className="flex justify-center">
            <MobileProjectCard isVideo={true} videoSrc="/videos/new-mobile-app-1.mp4" alt="E-commerce mobile app" isMobile={true} />
          </div>
